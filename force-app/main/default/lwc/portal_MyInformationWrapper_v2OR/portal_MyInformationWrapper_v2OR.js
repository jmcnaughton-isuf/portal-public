...
export default class Portal_MyInformationWrapper_v2OR extends LightningElement {
    ...
    get isDisplayContactTab() {
        return (this._customMetdataConfiguration.name.display
                || this._customMetdataConfiguration.alsoKnownAs.display
    ...
    handleSave = (event) => {
        ...
        let childComponentList = [
            ...
            this.template.querySelector('c-portal_-My-Information-Contact_v2-O-R'),
