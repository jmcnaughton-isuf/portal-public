...
export class ComponentLogic {
    ...
    get newEmployment() {
        return {
            ...
            status: "Current",
            employmentShowOnDirectory: false,
    ...
    handleAddEmployment() {
        this._recordList.push(this.newEmployment);
        this._lightningElement.componentAttributes.recordList = [...this._recordList];
    }

    handleDeleteEmployment(recordIndex) {
    ...
    handleLookupSelection(option, fieldId, recordIndex, sectionId, lookupFieldId) {
        this._recordList[recordIndex][lookupFieldId] = option.value;
    }
