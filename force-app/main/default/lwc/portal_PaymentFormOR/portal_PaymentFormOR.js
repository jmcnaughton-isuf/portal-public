...
// html
import cybersource from './portal_PaymentFormORCybersource.html';
import cybersourceCompact from './portal_PaymentFormORCybersourceCompact.html';
import cybersourceSelector from './portal_PaymentFormORCybersourceSelector.html';
import cybersourceSelectorCompact from './portal_PaymentFormORCybersourceSelectorCompact.html';
import spreedly from './portal_PaymentFormORSpreedly.html';
import spreedlyCompact from './portal_PaymentFormORSpreedlyCompact.html';
import spreedlySelector from './portal_PaymentFormORSpreedlySelector.html';
import spreedlySelectorCompact from './portal_PaymentFormORSpreedlySelectorCompact.html';
import stripe from './portal_PaymentFormORStripe.html';
import stripeCompact from './portal_PaymentFormORStripeCompact.html';
import stripePaymentElement from './portal_PaymentFormORStripePaymentElement.html';
import stripePaymentElementCompact from './portal_PaymentFormORStripePaymentElementCompact.html';
import touchNet from './portal_PaymentFormORTouchNet.html';
...
export default class Portal_PaymentFormOR extends LightningElement {
    ...
    get compactStyle() {
        ...
        return "width: 100%; max-width: 332px; height: 470px; border-style: none;";
    }
    ...
    initializeStripePaymentElementForm = (apiKey) => {
        try {
            console.log('isGivingAsOrg payment form');
            console.log(isGivingAsOrg);
            ...
            getStripeClientSecret(params).then(clientSecret => {
                console.log('brandonlook here');
                const opts = {
                    type: "initialize",
                    stripeKey: apiKey,
                    clientSecretKey: clientSecret,
                    isSubscription: this.isSubscription,
                    billingInformation: this.isGivingAsOrg ? this.organizationBillingInformation : this.billingInformation,
                    billingInformationOnPaymentPage: this.isGivingAsOrg ? this.organizationBillingInformation : this.billingInformation,
                    designationInformation: this.designationList,
